...
def distime():
    ...
    label_distime=tk.Label(root,text=ct2,bg="yellow",fg="red",font=("Arial",32))
    label_distime_canvas=canvas.create_window(245,670,window=label_distime)
...
btime=tk.Button(root,text="Display current date and time",bg="yellow",fg="red",height=2,font=("Arial ",18),command=distime)
btime_canvas=canvas.create_window(650,670,window=btime)

button_exit=tk.Button(root,text="CLOSE",bg="yellow",fg="red",height=2,command=exit)
button_exit=canvas.create_window(550,750,window=button_exit)
